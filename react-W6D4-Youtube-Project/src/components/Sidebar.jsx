    ...
    return (
        <div className="drawer">
            ...
            <div className="drawer-content">
                {/* Page content here */}
                <label htmlFor="my-drawer" className="w-11 h-11 flex justify-center items-center cursor-pointer bg-transparent hover:bg-slate-100 btn-circle border-transparent outline-none drawer-button">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        stroke="black"
                        viewBox="0 0 24 24"
                        className="inline-block h-6 w-6 max-sm:w-3 max-sm:h-3 ">
                        <path
                            strokeLinecap="round"
            ...
            <div className="drawer-side">
                ...
                <ul className="bg-white min-h-full w-80 p-4 text-black max-sm:w-40 max-sm:px-0 overflow-y-scroll">
                    ...
                    <li>
                        <div className='p-0 flex justify-start items-center'>
                            ...
                            <img className='w-28 max-sm:w-14 cursor-pointer' src={youtube} />
                        </div>
                    </li>
                    <li className='max-sm:w-full max-sm:text-[0.6rem]'>
                        <div className='flex justify-start items-center max-sm:pl-0 w-[90%] h-10 gap-3 pr-2 hover:bg-slate-100 rounded-lg cursor-pointer max-sm:h-7'>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="24"
                                viewBox="0 0 24 24"
                    ...
                    <li className='max-sm:w-full max-sm:text-[0.6rem]'>
                        <div className='flex justify-start items-center max-sm:pl-0 w-[90%] h-10 gap-3 pr-2 hover:bg-slate-100 rounded-lg cursor-pointer max-sm:h-7'>
                            ...
                            >
                                <path
                                    d="M11.03 12.65 6.38 8 11.03 3.35l-.71-.71L4.97 8l5.35 5.35.71-.7z">
                                </path>
                            </svg>
                        </div>
                    </li>
                    ...
                    <li className='max-sm:w-full max-sm:text-[0.6rem]'>
                        <div className='flex justify-start items-center max-sm:pl-0 w-[90%] h-10 gap-3 pr-2 hover:bg-slate-100 rounded-lg cursor-pointer max-sm:h-7'>
                            ...
                            <h1>الفيديوهات التي أعجبتني</h1>
                        </div>
                    </li>
                    <div className="divider"></div>
                    <h1 className=' max-sm:pl-0 pb-3 max-sm:w-full max-sm:text-[0.6rem]'>استكشاف</h1>
                    <li className='max-sm:w-full max-sm:text-[0.6rem]'>
                        <div className='flex justify-start items-center max-sm:pl-0 w-[90%] h-10 gap-3 pr-2 hover:bg-slate-100 rounded-lg cursor-pointer max-sm:h-7'>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="divider"></div>
                    <h1 className=' max-sm:pl-0 pb-3 max-sm:w-full max-sm:text-[0.6rem]'>المزيد من YouTube</h1>
                    <li className='max-sm:w-full max-sm:text-[0.6rem]'>
                        <div className='flex justify-start items-center max-sm:pl-0 w-[90%] h-10 gap-3 pr-2 hover:bg-slate-100 rounded-lg cursor-pointer max-sm:h-7'>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                <g fill="none" fillRule="evenodd">
                                    ...
                                    <g fillRule="nonzero">
                                        ...
                                        <path fill="url(#a_yt162)" fillOpacity=".1" d="M21.54 3.4s-.2-1.5-.86-2.18C19.85.35 18.93.35 18.5.3 15.46.07 10.9.1 10.9.1S6.34.07 3.3.3c-.43.05-1.35.05-2.18.92C.47 1.9.26 3.4.26 3.4S.04 5.17 0 6.95V8.6c.04 1.8.26 3.56.26 3.56s.2 1.52.86 2.18c.83.87 1.9.85 2.4.94 1.7.16 7.2.2 7.38.2 0 0 4.57 0 7.6-.2.43-.06 1.35-.07 2.18-.94.65-.66.86-2.18.86-2.18s.22-1.77.24-3.55V6.97c-.02-1.78-.24-3.55-.24-3.55z" transform="translate(1 4.208)"></path>
                                    </g>
                                </g>
                            </svg>
                    ...
                    <div className="divider"></div>
                    <li className='max-sm:w-full max-sm:text-[0.5rem]'>
                        <ul className='flex justify-start items-center flex-wrap gap-1 text-[#747474] pr-2 max-sm:pl-0 max-sm:mr-0'>
                            <li className='cursor-pointer ml-2'>حول</li>
                            <li className='cursor-pointer ml-2'>الصحافة</li>
                            <li className='cursor-pointer ml-2'>حقوق الطبع والنشر</li>
                            <li className='cursor-pointer ml-2'>التواصل معنا</li>
                            <li className='cursor-pointer ml-2'>صنّاع المحتوى</li>
                            <li className='cursor-pointer ml-2'>الإعلان</li>
                            <li className='cursor-pointer ml-2'>مطوّرو البرامج</li>
                        </ul>
                    </li>
                    <li className='max-sm:w-full max-sm:text-[0.5rem]'>
                        <ul className='flex justify-start items-center flex-wrap gap-1 my-4 text-[#747474] pr-2 max-sm:pl-0 max-sm:mr-0'>
                            <li className='cursor-pointer ml-2'>الأحكام</li>
                            <li className='cursor-pointer ml-2'>الخصوصية</li>
                            <li className='cursor-pointer ml-2'>السياسة والأمان</li>
                            <li className='cursor-pointer ml-2'>آلية عمل YouTube</li>
                            <li className='cursor-pointer ml-2'>تجربة الميزات الجديدة</li>
                        </ul>
                    </li>
                    <div className='flex justify-center items-center text-[#535353] max-sm:pl-0 max-sm:text-[0.6rem]'>
                        <p dir='ltr'>© 2024 Google LLC</p>
                    </div>
